...
* **The Education Premium:** Higher education yields a significant positive return. Holding a graduate-level education or higher increases the likelihood of employment by 10.6 percentage points (p < 0.001).
* **Age Dynamics:** Employment probability demonstrates a positive linear relationship with age within the prime working cohort, increasing by approximately 1.3 percentage points for each additional year of age.
